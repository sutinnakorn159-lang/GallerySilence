...
const STORIES_DATA = [
  ...
  },
  {
    ...
    fiction: "แปลกจัง ที่นี่ไม่มีใครรีบเร่งเลย ทุกคนกำลังเดินอย่างช้าๆ คล้ายกับรออะไรบางอย่าง แปลกจัง ที่นี่ไม่มีลมหนาว แต่กลับรู้สึกเย็นยะเยือก แปลกจัง ที่นี่ไม่มีฉันไม่เคยมาแต่ทำไมรู้สึกคุ้นเคย แปลกจัง ที่นี่ไม่มีใครพูดคุยกัน แต่ทำไมฉันรู้สึกเหมือนมีใครกำลังเฝ้ามองอยู่ แปลกจัง ที่นี่ไม่มีคนที่ฉันรู้จัก แต่ทำไมฉันรู้สึกเหมือนกำลังรอใครสักคน",
    mood: "NOSTALGIA"
  },
  {
    id: 3,
